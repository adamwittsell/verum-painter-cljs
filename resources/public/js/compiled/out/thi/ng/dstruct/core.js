...
if(cljs.core.truth_(temp__4423__auto__)){
var vec__25736 = temp__4423__auto__;
var k__$1 = cljs.core.nth.call(null,vec__25736,(0),null);
var vv = cljs.core.nth.call(null,vec__25736,(1),null);
...
return cljs.core.persistent_BANG_.call(null,cljs.core.reduce.call(null,(function (p1__25737_SHARP_,p2__25738_SHARP_){
return cljs.core.conj_BANG_.call(null,p1__25737_SHARP_,f.call(null,p2__25738_SHARP_));
...
thi.ng.dstruct.core.set_conj2_STAR_ = (function thi$ng$dstruct$core$set_conj2_STAR_(p1__25742_SHARP_,p2__25743_SHARP_){
if((p1__25742_SHARP_ == null)){
return p2__25743_SHARP_;
} else {
if(cljs.core.set_QMARK_.call(null,p1__25742_SHARP_)){
return cljs.core.conj.call(null,p1__25742_SHARP_,p2__25743_SHARP_);
} else {
return cljs.core.PersistentHashSet.fromArray([p1__25742_SHARP_,p2__25743_SHARP_], true);
}
}
});
thi.ng.dstruct.core.vec_conj2_STAR_ = (function thi$ng$dstruct$core$vec_conj2_STAR_(p1__25744_SHARP_,p2__25745_SHARP_){
if((p1__25744_SHARP_ == null)){
return p2__25745_SHARP_;
} else {
if(cljs.core.vector_QMARK_.call(null,p1__25744_SHARP_)){
return cljs.core.conj.call(null,p1__25744_SHARP_,p2__25745_SHARP_);
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__25744_SHARP_,p2__25745_SHARP_], null);
}
}
});
...
return thi.ng.dstruct.core.interval_set.cljs$core$IFn$_invoke$arity$variadic(argseq__17148__auto__);
});
...
thi.ng.dstruct.core.interval_set.cljs$lang$applyTo = (function (seq25746){
return thi.ng.dstruct.core.interval_set.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25746));
});
thi.ng.dstruct.core.check_intervals = (function thi$ng$dstruct$core$check_intervals(){
var argseq__17148__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return thi.ng.dstruct.core.check_intervals.cljs$core$IFn$_invoke$arity$variadic(argseq__17148__auto__);
});

thi.ng.dstruct.core.check_intervals.cljs$core$IFn$_invoke$arity$variadic = (function (ivals){
var vec__25748 = cljs.core.reduce.call(null,(function (p__25749,v){
var vec__25750 = p__25749;
var i = cljs.core.nth.call(null,vec__25750,(0),null);
var c = cljs.core.nth.call(null,vec__25750,(1),null);
if(cljs.core.sequential_QMARK_.call(null,v)){
...
var ivals__$1 = cljs.core.nth.call(null,vec__25748,(0),null);
var const$ = cljs.core.nth.call(null,vec__25748,(1),null);
return ((function (vec__25748,ivals__$1,const$){
return (function (x){
if(cljs.core.truth_(const$.call(null,x))){
return x;
} else {
return cljs.core.some.call(null,((function (vec__25748,ivals__$1,const$){
return (function (p__25751){
var vec__25752 = p__25751;
var a = cljs.core.nth.call(null,vec__25752,(0),null);
var b = cljs.core.nth.call(null,vec__25752,(1),null);
return ((a <= x)) && ((x <= b));
});})(vec__25748,ivals__$1,const$))
,ivals__$1);
}
});
;})(vec__25748,ivals__$1,const$))
...
thi.ng.dstruct.core.check_intervals.cljs$lang$applyTo = (function (seq25747){
return thi.ng.dstruct.core.check_intervals.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25747));
});
/**
...
var argseq__17148__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return thi.ng.dstruct.core.cartesian_product.cljs$core$IFn$_invoke$arity$variadic(argseq__17148__auto__);
});
...
var G__25754 = (i - (1));
var G__25755 = cljs.core.assoc.call(null,v_seqs__$2,i,v_original_seqs.call(null,i));
i = G__25754;
v_seqs__$2 = G__25755;
continue;
}
...
thi.ng.dstruct.core.cartesian_product.cljs$lang$applyTo = (function (seq25753){
return thi.ng.dstruct.core.cartesian_product.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25753));
});
/**
...
var vec__25758 = cljs.core.reduce.call(null,(function (p__25759,v){
var vec__25760 = p__25759;
var m = cljs.core.nth.call(null,vec__25760,(0),null);
var n = cljs.core.nth.call(null,vec__25760,(1),null);
...
var m = cljs.core.nth.call(null,vec__25758,(0),null);
var n = cljs.core.nth.call(null,vec__25758,(1),null);
...
var vec__25761 = thi.ng.dstruct.core.bisect.call(null,f,coll);
var m = cljs.core.nth.call(null,vec__25761,(0),null);
var n = cljs.core.nth.call(null,vec__25761,(1),null);
...
return thi.ng.dstruct.core.apply_to_keys.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__17148__auto__);
});
...
thi.ng.dstruct.core.apply_to_keys.cljs$lang$applyTo = (function (seq25770){
...
var G__25773 = cljs.core.first.call(null,seq25770__$2);
var seq25770__$3 = cljs.core.next.call(null,seq25770__$2);
return thi.ng.dstruct.core.apply_to_keys.cljs$core$IFn$_invoke$arity$variadic(G__25771,G__25772,G__25773,seq25770__$3);
});
...
var pairs = cljs.core.map.call(null,(function (p__25776){
var vec__25777 = p__25776;
var a = cljs.core.nth.call(null,vec__25777,(0),null);
var b = cljs.core.nth.call(null,vec__25777,(1),null);
...
var G__25779 = (i + (1));
var G__25780 = cljs.core.next.call(null,coll__$1);
i = G__25779;
coll__$1 = G__25780;
continue;
}
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__25783){
...
return ((0) <= flags.indexOf([cljs.core.str(p1__25785_SHARP_)].join('')));
});})(flags))
,xs);
} else {
return null;
...
//# sourceMappingURL=core.js.map?rel=1449311566425