...
return cljs.core.transduce.call(null,cljs.core.map.call(null,(function (p1__25941_SHARP_){
return cljs.core.apply.call(null,thi.ng.geom.core.utils.closest_point_on_segment,p,p1__25941_SHARP_);
...
return Math.sqrt(cljs.core.transduce.call(null,cljs.core.map.call(null,(function (p1__25942_SHARP_){
return thi.ng.geom.core.dist_squared.call(null,c,p1__25942_SHARP_);
})),rf,(0),points));
});
});
...
return cljs.core.transduce.call(null,cljs.core.map.call(null,(function (p1__25943_SHARP_){
return thi.ng.geom.core.dist.call(null,p1__25943_SHARP_.call(null,(0)),p1__25943_SHARP_.call(null,(1)));
...
thi.ng.geom.core.utils.centroid = (function thi$ng$geom$core$utils$centroid(p__25944){
var vec__25947 = p__25944;
var x = cljs.core.nth.call(null,vec__25947,(0),null);
var xs = cljs.core.nthnext.call(null,vec__25947,(1));
var coll = vec__25947;
var G__25948 = cljs.core.count.call(null,coll);
switch (G__25948) {
case (0):
return null;
...
var f = ((function (s,G__25948,vec__25947,x,xs,coll){
return (function (x__$1,_){
return (x__$1 * s);
});})(s,G__25948,vec__25947,x,xs,coll))
;
...
return thi.ng.geom.core._PLUS_.call(null,p1__25950_SHARP_,d);
});})(d))
,coll);
});
...
return cljs.core.mapv.call(null,(function (p1__25954_SHARP_){
return thi.ng.geom.core.madd.call(null,thi.ng.geom.core._.call(null,p1__25954_SHARP_,c),s,c);
}),coll);
});

thi.ng.geom.core.utils.scale_size.cljs$lang$maxFixedArity = 3;
thi.ng.geom.core.utils.bounds_STAR_ = (function thi$ng$geom$core$utils$bounds_STAR_(zero,p__25958){
var vec__25960 = p__25958;
var x = cljs.core.nth.call(null,vec__25960,(0),null);
var xs = cljs.core.nthnext.call(null,vec__25960,(1));
var coll = vec__25960;
...
var xs = cljs.core.mapv.call(null,(function (p1__25961_SHARP_){
return cljs.core.nth.call(null,p1__25961_SHARP_,axis);
}),coll);
...
return cljs.core.some.call(null,(function (p1__25962_SHARP_){
return thi.ng.math.core.delta_EQ_.call(null,p,p1__25962_SHARP_,eps);
}),points);
});
...
var idx__$1 = (function (){var or__16108__auto__ = idx;
...
while(true){
if((t < 1.0)){
var vec__25968 = thi.ng.geom.core.utils.point_at_STAR_.call(null,points,idx,total,t,i);
var p = cljs.core.nth.call(null,vec__25968,(0),null);
var i__$1 = cljs.core.nth.call(null,vec__25968,(1),null);
var G__25969 = (t + delta);
var G__25970 = (i__$1 | (0));
var G__25971 = cljs.core.conj.call(null,acc,p);
t = G__25969;
i = G__25970;
acc = G__25971;
continue;
...
var ls = (function (){var iter__16862__auto__ = (function thi$ng$geom$core$utils$sample_segment_with_res_$_iter__25976(s__25977){
return (new cljs.core.LazySeq(null,(function (){
var s__25977__$1 = s__25977;
while(true){
var temp__4425__auto__ = cljs.core.seq.call(null,s__25977__$1);
if(temp__4425__auto__){
var s__25977__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__25977__$2)){
var c__16860__auto__ = cljs.core.chunk_first.call(null,s__25977__$2);
var size__16861__auto__ = cljs.core.count.call(null,c__16860__auto__);
var b__25979 = cljs.core.chunk_buffer.call(null,size__16861__auto__);
if((function (){var i__25978 = (0);
while(true){
if((i__25978 < size__16861__auto__)){
var t = cljs.core._nth.call(null,c__16860__auto__,i__25978);
cljs.core.chunk_append.call(null,b__25979,thi.ng.geom.core.mix.call(null,a,b,t));

var G__25980 = (i__25978 + (1));
i__25978 = G__25980;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25979),thi$ng$geom$core$utils$sample_segment_with_res_$_iter__25976.call(null,cljs.core.chunk_rest.call(null,s__25977__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25979),null);
}
} else {
var t = cljs.core.first.call(null,s__25977__$2);
return cljs.core.cons.call(null,thi.ng.geom.core.mix.call(null,a,b,t),thi$ng$geom$core$utils$sample_segment_with_res_$_iter__25976.call(null,cljs.core.rest.call(null,s__25977__$2)));
}
} else {
return null;
}
...
return iter__16862__auto__.call(null,thi.ng.math.core.norm_range.call(null,res));
})();
 ...
 */
thi.ng.geom.core.utils.map_bilinear = (function thi$ng$geom$core$utils$map_bilinear(p__25981,p__25982){
var vec__25985 = p__25981;
var a = cljs.core.nth.call(null,vec__25985,(0),null);
var b = cljs.core.nth.call(null,vec__25985,(1),null);
var c = cljs.core.nth.call(null,vec__25985,(2),null);
var d = cljs.core.nth.call(null,vec__25985,(3),null);
var vec__25986 = p__25982;
var u = cljs.core.nth.call(null,vec__25986,(0),null);
var v = cljs.core.nth.call(null,vec__25986,(1),null);
 ...
 */
thi.ng.geom.core.utils.map_trilinear = (function thi$ng$geom$core$utils$map_trilinear(p__25987,p__25988){
var vec__25991 = p__25987;
var a = cljs.core.nth.call(null,vec__25991,(0),null);
var b = cljs.core.nth.call(null,vec__25991,(1),null);
var c = cljs.core.nth.call(null,vec__25991,(2),null);
var d = cljs.core.nth.call(null,vec__25991,(3),null);
var e = cljs.core.nth.call(null,vec__25991,(4),null);
var f = cljs.core.nth.call(null,vec__25991,(5),null);
var g = cljs.core.nth.call(null,vec__25991,(6),null);
var h = cljs.core.nth.call(null,vec__25991,(7),null);
var vec__25992 = p__25988;
var u = cljs.core.nth.call(null,vec__25992,(0),null);
var v = cljs.core.nth.call(null,vec__25992,(1),null);
var w = cljs.core.nth.call(null,vec__25992,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__25993_SHARP_){
return (new cljs.core.PersistentVector(null,3,(5),cljs.core.PersistentVector.EMPTY_NODE,[c,p1__25993_SHARP_.call(null,(0)),p1__25993_SHARP_.call(null,(1))],null));
...
var vec__26000 = points;
var v0 = cljs.core.nth.call(null,vec__26000,(0),null);
var more = cljs.core.nthnext.call(null,vec__26000,(1));
return cljs.core.mapv.call(null,((function (vec__26000,v0,more){
return (function (p__26001){
var vec__26002 = p__26001;
var a = cljs.core.nth.call(null,vec__26002,(0),null);
var b = cljs.core.nth.call(null,vec__26002,(1),null);
...
thi.ng.geom.core.utils.tessellate_tri_with_midpoints = (function thi$ng$geom$core$utils$tessellate_tri_with_midpoints(p__26003){
var vec__26005 = p__26003;
var a = cljs.core.nth.call(null,vec__26005,(0),null);
var b = cljs.core.nth.call(null,vec__26005,(1),null);
var c = cljs.core.nth.call(null,vec__26005,(2),null);
...
var expr__26011 = cljs.core.count.call(null,points);
if(cljs.core.truth_(pred__26010.call(null,(3),expr__26011))){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [points], null);
} else {
if(cljs.core.truth_(pred__26010.call(null,(4),expr__26011))){
var vec__26013 = points;
var a = cljs.core.nth.call(null,vec__26013,(0),null);
var b = cljs.core.nth.call(null,vec__26013,(1),null);
var c = cljs.core.nth.call(null,vec__26013,(2),null);
var d = cljs.core.nth.call(null,vec__26013,(3),null);
...
thi.ng.geom.core.utils.ortho_normal.cljs$core$IFn$_invoke$arity$1 = (function (p__26016){
var vec__26017 = p__26016;
var a = cljs.core.nth.call(null,vec__26017,(0),null);
var b = cljs.core.nth.call(null,vec__26017,(1),null);
var c = cljs.core.nth.call(null,vec__26017,(2),null);
...
thi.ng.geom.core.utils.norm_sign2 = (function thi$ng$geom$core$utils$norm_sign2(p__26019,p__26020,p__26021){
var vec__26025 = p__26019;
var ax = cljs.core.nth.call(null,vec__26025,(0),null);
var ay = cljs.core.nth.call(null,vec__26025,(1),null);
var vec__26026 = p__26020;
var bx = cljs.core.nth.call(null,vec__26026,(0),null);
var by = cljs.core.nth.call(null,vec__26026,(1),null);
var vec__26027 = p__26021;
var cx = cljs.core.nth.call(null,vec__26027,(0),null);
var cy = cljs.core.nth.call(null,vec__26027,(1),null);
...
thi.ng.geom.core.utils.triangle_barycentric_coords.cljs$core$IFn$_invoke$arity$2 = (function (p__26030,p){
var vec__26031 = p__26030;
var a = cljs.core.nth.call(null,vec__26031,(0),null);
var b = cljs.core.nth.call(null,vec__26031,(1),null);
var c = cljs.core.nth.call(null,vec__26031,(2),null);
...
var vec__26034 = thi.ng.geom.core.utils.triangle_barycentric_coords.call(null,a,b,c,p,u,v);
var u__$1 = cljs.core.nth.call(null,vec__26034,(0),null);
var v__$1 = cljs.core.nth.call(null,vec__26034,(1),null);
var w = cljs.core.nth.call(null,vec__26034,(2),null);
var and__16096__auto__ = (u__$1 >= 0.0);
...
thi.ng.geom.core.utils.area_xf = thi.ng.geom.core.utils.tessellating_transducer.call(null,(function (p1__26035_SHARP_){
return thi.ng.math.core.abs.call(null,cljs.core.apply.call(null,thi.ng.geom.core.utils.tri_area3,p1__26035_SHARP_));
}));
thi.ng.geom.core.utils.volume_xf = thi.ng.geom.core.utils.tessellating_transducer.call(null,(function (p1__26036_SHARP_){
return thi.ng.geom.core.dot.call(null,p1__26036_SHARP_.call(null,(0)),thi.ng.geom.core.cross.call(null,p1__26036_SHARP_.call(null,(1)),p1__26036_SHARP_.call(null,(2))));
}));
...
//# sourceMappingURL=utils.js.map?rel=1449311567161