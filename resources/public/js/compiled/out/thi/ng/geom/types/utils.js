...
var vec__25923 = thi.ng.geom.core.utils.bounding_rect.call(null,points);
var p = cljs.core.nth.call(null,vec__25923,(0),null);
var size = cljs.core.nth.call(null,vec__25923,(1),null);
...
var vec__25925 = thi.ng.geom.core.utils.bounding_box.call(null,points);
var p = cljs.core.nth.call(null,vec__25925,(0),null);
var size = cljs.core.nth.call(null,vec__25925,(1),null);
if(cljs.core.truth_(p)){
...
var vec__25928 = thi.ng.geom.core.utils.radial_bounds.call(null,thi.ng.geom.core.vector.vec2,c,r_or_points);
var c__$1 = cljs.core.nth.call(null,vec__25928,(0),null);
var r = cljs.core.nth.call(null,vec__25928,(1),null);
...
var vec__25932 = thi.ng.geom.core.utils.radial_bounds.call(null,thi.ng.geom.core.vector.vec3,c,r_or_points);
var c__$1 = cljs.core.nth.call(null,vec__25932,(0),null);
var r = cljs.core.nth.call(null,vec__25932,(1),null);
...
return thi.ng.geom.core.scale_size.call(null,thi.ng.geom.core.center.call(null,p1__25934_SHARP_,thi.ng.geom.core.unmap_point.call(null,b_SINGLEQUOTE_,thi.ng.geom.core.map_point.call(null,b,thi.ng.geom.core.centroid.call(null,p1__25934_SHARP_)))),s);
});})(b,s,b_SINGLEQUOTE_))
,coll);
});
thi.ng.geom.types.utils.into_mesh = (function thi$ng$geom$types$utils$into_mesh(mesh,add_face,mesh_or_faces){
return cljs.core.reduce.call(null,add_face,mesh,(((function (){var G__25936 = mesh_or_faces;
if(G__25936){
...
return G__25936.thi$ng$geom$core$PFaceAccess$;
}
})())){
return true;
} else {
if((!G__25936.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,thi.ng.geom.core.PFaceAccess,G__25936);
} else {
return false;
}
}
...
var tx__$1 = (((function (){var G__25938 = tx;
if(G__25938){
var bit__16782__auto__ = null;
if(cljs.core.truth_((function (){var or__16108__auto__ = bit__16782__auto__;
if(cljs.core.truth_(or__16108__auto__)){
...
return G__25938.thi$ng$geom$core$PVectorTransform$;
}
})())){
return true;
} else {
if((!G__25938.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,thi.ng.geom.core.PVectorTransform,G__25938);
} else {
return false;
}
}
...
//# sourceMappingURL=utils.js.map?rel=1449311566948