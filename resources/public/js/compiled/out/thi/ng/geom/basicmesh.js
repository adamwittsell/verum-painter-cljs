...
return thi.ng.dstruct.core.successive_nth.call(null,(2),cljs.core.conj.call(null,p1__25725_SHARP_,cljs.core.first.call(null,p1__25725_SHARP_)));
});})(___$1))
...
var ___$1 = this;
return new cljs.core.Keyword(null,"fnormals","fnormals",-1783998563).cljs$core$IFn$_invoke$arity$1(___$1).call(null,f);
});
...
var G__25731 = cljs.core.assoc_BANG_.call(null,fnorms,f,thi.ng.geom.core.utils.ortho_normal.call(null,f));
var G__25732 = cljs.core.next.call(null,faces);
fnorms = G__25731;
faces = G__25732;
continue;
} else {
...
return (thi.ng.dstruct.core.index_of.call(null,p1__25726_SHARP_,v) >= (0));
});})(___$1))
...
return thi.ng.geom.core._PLUS_.call(null,p1__25730_SHARP_,t);
});})(___$1))
);
});
...
return thi.ng.geom.core._STAR_.call(null,p1__25727_SHARP_,s);
});})(___$1))
);
});
...
return thi.ng.geom.core._STAR_.call(null,p1__25728_SHARP_,sx,sy,sz);
});})(___$1))
);
});
...
return thi.ng.geom.core.madd.call(null,thi.ng.geom.core._.call(null,p1__25729_SHARP_,c),s,c);
});})(c,___$1))
);
});
...
var ___$1 = this;
return thi.ng.geom.types.utils.map_mesh.call(null,(function (){var or__16108__auto__ = new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(opts);
...
//# sourceMappingURL=basicmesh.js.map?rel=1449311566269